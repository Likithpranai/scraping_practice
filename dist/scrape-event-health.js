...
async function scrapeHealthEvents() {
    ...
    try {
        ...
        eventFood_service_1.default.baseUrl = 'https://www.eventbrite.hk/d/hong-kong-sar/health--events/';
        // Scrape pages 1-4
        console.log('Scraping health events from pages 1-4...');
        const healthEvents = await eventFood_service_1.default.scrapeEvents(4);
        // Save results
        const outputPath = path_1.default.join(__dirname, '../results/eventbrite_health.json');
        fs_1.default.writeFileSync(outputPath, JSON.stringify(healthEvents, null, 2));
...
scrapeHealthEvents();
//# sourceMappingURL=scrape-event-health.js.map