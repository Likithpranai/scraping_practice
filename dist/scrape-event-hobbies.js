...
async function scrapeHobbiesEvents() {
    ...
    try {
        ...
        eventFood_service_1.default.baseUrl = 'https://www.eventbrite.hk/d/hong-kong-sar/hobbies--events/';
        // Scrape page 1 only
        console.log('Scraping hobbies events from page 1...');
        const hobbiesEvents = await eventFood_service_1.default.scrapeEvents(1);
        // Save results
        const outputPath = path_1.default.join(__dirname, '../results/eventbrites_hobbies.json');
        fs_1.default.writeFileSync(outputPath, JSON.stringify(hobbiesEvents, null, 2));
...
scrapeHobbiesEvents();
//# sourceMappingURL=scrape-event-hobbies.js.map