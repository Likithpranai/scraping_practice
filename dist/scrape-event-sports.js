...
async function scrapeSportsEvents() {
    ...
    try {
        ...
        eventFood_service_1.default.baseUrl = 'https://www.eventbrite.hk/d/hong-kong-sar/sports-and-fitness--events/';
        // Scrape page 1 only
        console.log('Scraping sports and fitness events from page 1...');
        const sportsEvents = await eventFood_service_1.default.scrapeEvents(1);
        // Save results
        const outputPath = path_1.default.join(__dirname, '../results/eventbrites_sports.json');
        fs_1.default.writeFileSync(outputPath, JSON.stringify(sportsEvents, null, 2));
...
scrapeSportsEvents();
//# sourceMappingURL=scrape-event-sports.js.map