...
async function scrapeTravelEvents() {
    ...
    try {
        ...
        eventFood_service_1.default.baseUrl = 'https://www.eventbrite.hk/d/hong-kong-sar/travel-and-outdoor--events/';
        // Scrape page 1 only
        console.log('Scraping travel and outdoor events from page 1...');
        const travelEvents = await eventFood_service_1.default.scrapeEvents(1);
        // Save results
        const outputPath = path_1.default.join(__dirname, '../results/eventbrites_travel.json');
        fs_1.default.writeFileSync(outputPath, JSON.stringify(travelEvents, null, 2));
...
scrapeTravelEvents();
//# sourceMappingURL=scrape-event-travel.js.map