...
class EventFoodService {
    constructor() {
        this.baseUrl = 'https://www.eventbrite.hk/d/hong-kong-sar/food-and-drink--events/';
    }
    ...
    async getEventDetails(page, url) {
        try {
    ...
    async scrapeEventsFromPage(pageNumber = 1) {
    ...
    async scrapeAdditionalPages(pageNumbers) {
...
exports.default = new EventFoodService();
//# sourceMappingURL=eventFood.service.js.map