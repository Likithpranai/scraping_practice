...
exports.OpenRiceMostBookmarkedStrategy = void 0;
...
class OpenRiceMostBookmarkedStrategy extends IStrategy_1.IStrategy {
    constructor() {
        super('hong-kong', 'restaurants', 'openrice');
        this.baseUrl = 'https://www.openrice.com/zh/hongkong/explore/chart/most-bookmarked?_sUrl=https%3A%2F%2Fs.openrice.com%2FQrbe0000000';
    }
    async get_info() {
        ...
        try {
            ...
            const restaurantPages = await scraper_service_1.default.scrapeMultiplePages(restaurantLinks.map(link => link.url).slice(0, 20) // Limit to 20 for this example
            );
...
exports.OpenRiceMostBookmarkedStrategy = OpenRiceMostBookmarkedStrategy;
//# sourceMappingURL=openrice.most_bookmarked.strategy.js.map