...
export interface Restaurant {
  ...
  // /**
  //  * A short, concise summary description of the restaurant.
  //  * @example "A long-running Michelin Bib Gourmand award winner..."
  //  */
	// description: string;
	
	// /**
	//  * An array of days of the week when the restaurant is closed.
	//  * This allows for flexibility in representing both regular closing days and special closures.
	//  * @example ["Sunday", "Monday"]
	//  */
	// closing_days_of_week?: string[];

	// /**
	//  * An array of specific dates when the restaurant is closed.
	//  * This allows for flexibility in representing both regular closing days and special closures.
...
export const RestaurantDefinitions = `
export interface Restaurant {
  /**
   * The primary, English-language name of the establishment.
   * @example "Yat Lok"
